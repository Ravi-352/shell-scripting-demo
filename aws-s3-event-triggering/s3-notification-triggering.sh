...
aws s3 cp ./sample_file.txt s3://"$bucket_name"/sample_file.txt
...
aws sns publish \
  ...
  --message "Hello from ravi_kiran; Please subscribe to the Notifications!"
